    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "$ref": "#/definitions/models.CheckResponseFullData"
                                        }
                                    }
                                }
                            ]
        ...
        "/v1/issues": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные новой угрозы",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/issues/{issueId}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Идентификатор угрозы",
                        "name": "issueId",
                        "in": "path",
                        "required": true
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.RuleFullData"
                                            }
                                        }
                                    }
                                }
        ...
        "/v1/severities": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные нового уровня опасности",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateSeverityRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "$ref": "#/definitions/models.SeverityResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "models.RuleFullData": {
            ...
            "properties": {
                ...
                "issue": {
                    "$ref": "#/definitions/models.IssueFullData"
                },
                "name": {
                    "type": "string"
                }
